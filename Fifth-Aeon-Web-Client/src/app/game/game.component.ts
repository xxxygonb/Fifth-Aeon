...
export class GameComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit() {
        this.hotkeys[0].description = this.i18n.tr('Pass');
        this.hotkeys[1].description = this.i18n.tr('Attack with all');
    ...
    public phaseName() {
        switch (this.game.getPhase()) {
            case GamePhase.Play1:
                return this.i18n.tr('first play phase');
            case GamePhase.Play2:
                return this.i18n.tr('second play phase');
            case GamePhase.Block:
                return this.i18n.tr('block phase');
            case GamePhase.DamageDistribution:
                return this.i18n.tr('damage distribution phase');
            case GamePhase.End:
                return this.i18n.tr('discard phase');
        }
    }
    ...
    public getPassText(): string {
        if (!this.game.canTakeAction()) {
            return this.i18n.tr('Waiting for Choice');
        }
        if (this.game.isPlayerTurn(this.playerNo)) {
            if (this.game.isAttacking()) {
                if (this.game.isActivePlayer(this.playerNo)) {
                    return this.i18n.tr('Attack');
                } else {
                    return this.i18n.tr('Waiting for Blocks');
                }
            }
            if (this.game) {
                if (this.canPlayResource()) {
                    return this.i18n.tr('Play a Resource');
                }
                return this.i18n.tr('End Turn');
            }
        } else {
            if (this.game.isActivePlayer(this.playerNo)) {
                return this.i18n.tr('Done Blocking');
            }
            return this.i18n.tr('Enemy Turn');
        }
